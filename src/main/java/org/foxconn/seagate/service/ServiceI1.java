...
public interface ServiceI1 {
	 public String getSSNStatusByInput(@WebParam(name  = "strSSN")String strSSN)  throws AxisFault;
	 public String updateSSNStatusByInput(@WebParam(name  = "PlantCode")String PlantCode,@WebParam(name  = "SSN")String SSN, @WebParam(name  = "FixtureID")String FixtureID,
