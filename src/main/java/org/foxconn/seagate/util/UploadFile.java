...
public class UploadFile {
		...
		public static boolean deleteFile(String url,// FTP服务器hostname
				int port,// FTP服务器端口
				String username, // FTP登录账号
				String password, // FTP登录密码
				String path, // FTP服务器保存目录
		...
		public static void deleteFromProduction(String url,// FTP服务器hostname
				int port,// FTP服务器端口
				String username, // FTP登录账号
				String password, // FTP登录密码
				String path, // FTP服务器保存目录
			...
			try {
				boolean flag = deleteFile(url, port, username, password, path,filename);
				System.out.println(flag);
			} catch (Exception e) {
				e.printStackTrace();
			}
		...
		public static void main(String[] args) {
			upLoadFromProduction("10.67.70.95", 20, "it", "it", "/ftptest", "test2.txt", "C:\\Users\\H7108464\\Desktop\\新文字文件.txt");
